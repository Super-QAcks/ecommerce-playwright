...
- Name: ui/tests/loging.spec.ts >> Test Case 3: Login User with incorrect email and password: 
- Location: ui/tests/loging.spec.ts:58:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com/ port 443 on Wednesday, 24-Jun-2026 17:42:10 MST
      - text: .
