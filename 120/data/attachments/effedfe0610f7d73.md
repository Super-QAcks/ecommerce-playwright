...
- Name: ui/tests/seed.spec.ts >> seed for logged in user >> seed using loginPage fixture
- Location: ui/tests/seed.spec.ts:4:6
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e4]:
      ...
      - link "WebMaster" [ref=e5] [cursor=pointer]:
        - /url: mailto:webmaster@automationexercise.com?subject=Error message [403] (none) for automationexercise.com//login port 443 on Wednesday, 24-Jun-2026 17:43:46 MST
      - text: .
